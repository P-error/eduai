...
const enMessages = {
  ...
  adminOverview: {
    ...
    runtimeArtifactStatus: "Runtime artifact status",
...
const ruMessages: UiMessages = {
  ...
  adminOverview: {
    ...
    runtimeBackend: "Runtime backend",
    runtimeArtifactStatus: "Статус runtime artifact",
    runtimeIntegration: "Интеграция runtime",
    runtimeWarning: "Предупреждение runtime",
